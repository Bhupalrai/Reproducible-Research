...
These formulas gives a mean and median of **`r as.integer(mean(sum_data$total))`** and 
**`r as.integer(median(sum_data$total))`** respectively.
...
# Rename the attributes here
names(mean_data) <- c("daytype", "weekdays", "interval", "mean")
```
